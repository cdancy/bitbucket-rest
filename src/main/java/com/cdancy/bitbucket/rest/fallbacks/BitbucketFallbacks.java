...
public final class BitbucketFallbacks {
    ...
    public static final class LabelsByNameOnError implements Fallback<Object> {
        @Override
        public Object createOrPropagate(final Throwable throwable) throws Exception {
            if (checkNotNull(throwable, "throwable") != null) {
                return createLabelsByNameFromErrors(getErrors(throwable.getMessage()));
            }
            throw propagate(throwable);
        }
    }
    ...
    public static Labels createLabelsByNameFromErrors(final List<Error> errors) {
        return Labels.create("", errors);
    }
