...
@AutoValue
public abstract class WebHookPage implements Page<WebHook>, ErrorsHolder {

    @SerializedNames({"start", "limit", "size", "nextPageStart", "isLastPage", "values", "errors" })
    public static WebHookPage create(final int start,
                                     final int limit,
                                     final int size,
                                     final int nextPageStart,
                                     final boolean isLastPage,
                                     @Nullable final List<WebHook> values,
                                     @Nullable final List<Error> errors) {

        return new AutoValue_WebHookPage(start,
            limit,
            size,
            nextPageStart,
            isLastPage,
