...
public abstract class Commit {
    ...
    public abstract List<Parent> parents();
    ...
    public static Commit create(String id, String displayId, Author author,
                                long authorTimestamp, String message, List<Parent> parents) {
        return new AutoValue_Commit(id, displayId, author, authorTimestamp, message,
                parents != null ? ImmutableList.copyOf(parents) : ImmutableList.<Parent>of());
    }
}
