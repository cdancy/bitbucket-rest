...
@AutoValue
public abstract class InsightReportPage implements Page<InsightReport>, ErrorsHolder {
    @SerializedNames({"start", "limit", "size", "nextPageStart", "isLastPage", "values", "errors"})
    public static InsightReportPage create(final int start,
                                    final int limit,
                                    final int size,
                                    final int nextPageStart,
                                    final boolean isLastPage,
                                    @Nullable final List<InsightReport> values,
                                    @Nullable final List<Error> errors) {

        return new AutoValue_InsightReportPage(start,
            limit,
            size,
            nextPageStart,
            isLastPage,
