...
public abstract class CreateWebHook {
    ...
    public abstract List<WebHook.EventType> events();
    ...
    @SerializedNames({ "name", "events", "configuration", "url", "active" })
    public static CreateWebHook create(final String name,
        ...
        return new AutoValue_CreateWebHook(name, events, configuration, url, active);
    }
}
