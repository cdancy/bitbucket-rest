...
public class BranchApiMockTest extends BaseBitbucketMockTest {
    ...
    public void testListBranches() throws Exception {
        ...
        try {
            ...
            JsonElement buildStatusMetadata = branch.values().get(0).metadata().get(buildStatusKey);
            BuildStatusInfo buildStatus = BuildStatusInfo.newBuilder().fromJsonElement(buildStatusMetadata).build();

            assertThat(buildStatus.successful).isEqualTo(1);
    ...
    private static class BuildStatusInfo {
        ...
        private static class BuildStatusInfoBuilder {
            ...
            BuildStatusInfoBuilder fromJsonElement(JsonElement buildStatus) {
                this.successful = ((JsonObject)buildStatus).get("successful").getAsInt();
                return this;
            }
